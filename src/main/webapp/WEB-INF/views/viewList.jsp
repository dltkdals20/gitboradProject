		...
		<div class="row">
			<form method="post" action="/write/writeView">
				...
				<c:if test = "${sessionScope.nickName == list.nicName}"> 
					<button class="btn btn-primary pull-left" type="button" onclick="location.href='/list/updating?bbsID=${list.id}'">수정</button>
					<button class="btn btn-primary pull-left" type="button" onclick="location.href='/list/delete?bbsID=${list.id}'">삭제</button>
				</c:if> 
