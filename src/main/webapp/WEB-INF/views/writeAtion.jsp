...
<body>
	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute ="list"  method="post" action="/update/updating">
					...
					<tbody>
						<tr>
							<td><form:input type="text" class="form-control"
								placeholder="제목" name="title" path="title"  maxlength="100"/></td><form:errors path="title"/></td>
						</tr>
						
						<tr>
							<td><form:input type="text" class="form-control"
								placeholder="여행 지역" name="location" path="location" maxlength="100"/></td><form:errors path="location"/></td>
						</tr>
						
						<tr>
							<td><form:input type="hidden" class="form-control"
								path="id" name="id" value="${list.id}" /></td>
						</tr>
						
						<tr>
							<td><form:input type="date" class="form-control"
								placeholder="여행 날짜" name="date" path="date"  maxlength="50"/>
						</tr>
						<tr>	
						...
						<tr>
							<td><form:input type="number" step="0.1" class="form-control"
								path="star"  placeholder="평점" name="bbsTitle" value="3" maxlength="50"/></td>
						</tr>
					</tbody>
