...
<body>
	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute ="list"  method="post" action="/list/Listupdating">
					...
					<tbody>
						<tr>
							<td><form:input type="text" class="form-control"
								placeholder="제목" name="title" path="title"  maxlength="100"/></td>
						</tr>
						
						<tr>
							<td><form:input type="text" class="form-control"
								placeholder="여행 지역" name="location" path="location" maxlength="100"/></td>
						</tr>
						...
						<tr>
							<td><form:input type="hidden" class="form-control"
								path="nicName" name="id" value="${list.nicName}" /></td>
						</tr>
